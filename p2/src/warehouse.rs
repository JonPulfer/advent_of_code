...
impl<'a> Address<'a> {
    ...
    pub fn compare(&self, other: &Address) ->(bool, usize) {
        ...
        for p in 0..other.raw.len() {
            ...
            let our_mask:String = [our_parts.0, "?", &our_parts.1[1..our_parts.1.len()]]
                .join("");

            let other_parts = other.raw.split_at(p);
            let other_mask:String = [other_parts.0, "?", &other_parts.1[1..other_parts.1.len()]]
                .join("");
    ...
    pub fn drop_col(&self, col: usize) -> String {
        ...
        let our_result:String = [our_parts.0, &our_parts.1[1..our_parts.1.len()]]
            .join("");
        return our_result;
    }
}
